...
plane.tweenForce=tween_value({start:plane.uniforms.hoveringWaveForce.value,end:to,time:1.25,callbacks:{onUpdate:function(value){plane.uniforms.hoveringWaveForce.value=value;},onComplete:function(){tween_stop(plane.tweenForce);plane.tweenForce=null;}}});}
function change_padding(to){if(plane.tweenPadding){tween_stop(plane.tweenPadding);}
plane.tweenPadding=tween_value({start:plane.uniforms.padding.value,end:to,time:1.25,callbacks:{onUpdate:function(value){plane.uniforms.padding.value=value;},onComplete:function(){tween_stop(plane.tweenPadding);plane.tweenPadding=null;}}});}
...
plane.tween=tween_value({start:plane.uniforms.mouseMoveStrength.value,end:to,time:1.25,callbacks:{onUpdate:function(value){plane.uniforms.mouseMoveStrength.value=value;},onComplete:function(){tween_stop(plane.tween);plane.tween=null}}});}
function change_padding(to){if(plane.tweenPadding){tween_stop(plane.tweenPadding);}
plane.tweenPadding=tween_value({start:plane.uniforms.padding.value,end:to,time:1.25,callbacks:{onUpdate:function(value){plane.uniforms.padding.value=value;},onComplete:function(){tween_stop(plane.tweenPadding);plane.tweenPadding=null;}}});}
function change_scale(to){if(plane.tweenScale){tween_stop(plane.tweenScale);}
if(!permanentDrawing){curtains.enableDrawing();}
...
plane.tweenForce=tween_value({start:plane.uniforms.wavesForce.value,end:to,time:1.25,callbacks:{onUpdate:function(value){plane.uniforms.wavesForce.value=value;},onComplete:function(){tween_stop(plane.tweenForce);plane.tweenForce=null;}}});}
function change_scale(to){if(plane.tweenScale){tween_stop(plane.tweenScale);}
if(!permanentDrawing){curtains.enableDrawing();}
...
plane.tween=tween_value({start:plane.uniforms.mouseOver.value,end:to,time:1.25,callbacks:{onUpdate:function(value){plane.uniforms.mouseOver.value=value;},onComplete:function(){tween_stop(plane.tween);plane.tween=null}}});}
function change_scale(to){if(plane.tweenScale){tween_stop(plane.tweenScale);}
if(!permanentDrawing){curtains.enableDrawing();}
...
function mouse_enter(){if(!mouseIn){mouseIn=true;activeImage=1;change_scale(1);}}
function mouse_leave(){if(mouseIn){mouseIn=false;activeImage=0;change_scale(0);}}
elm.addEventListener("mousemove",mouse_move);elm.addEventListener("touchmove",mouse_move);elm.addEventListener("mouseenter",mouse_enter);elm.addEventListener("touchstart",mouse_enter);elm.addEventListener("mouseleave",mouse_leave);elm.addEventListener("touchend",mouse_leave);}).onRender(function(){plane.uniforms.time.value+=0.01;plane.uniforms.wavesTime.value++;}).onAfterResize(function(){});function change_scale(to){if(plane.tweenScale){tween_stop(plane.tweenScale);}
if(!permanentDrawing&&to==1){curtains.enableDrawing();}
plane.tweenScale=tween_value({start:scaleFactor,end:to,time:0.6,callbacks:{onUpdate:function(value){scaleFactor=value;plane.uniforms.scaleFactor.value=value;if(scaleOnHover){plane.textures&&plane.textures[0].setScale(1+value/12,1+value/12);}},onComplete:function(){tween_stop(plane.tweenScale);plane.tweenScale=null;if(!permanentDrawing&&to==0){curtains.disableDrawing();}}}});}}
...
function change_scroll(to){if(plane.tween){tween_stop(plane.tween);}
plane.tween=tween_value({start:plane.uniforms.scrollSpeed.value,end:to,time:1.5,callbacks:{onUpdate:function(value){plane.uniforms.scrollSpeed.value=value*scrollDirection;},onComplete:function(){scrollDirection=0;scrollY=-1;plane.uniforms.scrollSpeed.value=0;tween_stop(plane.tween);plane.tween=null;}}});}
function change_scale(to){if(plane.tweenScale){tween_stop(plane.tweenScale);}
if(!permanentDrawing&&to==1){curtains.enableDrawing();}
plane.tweenScale=tween_value({start:scaleFactor,end:to,time:1.0,callbacks:{onUpdate:function(value){scaleFactor=value;if(scaleOnHover){plane.textures&&plane.textures[0].setScale(1+value/12,1+value/12);}},onComplete:function(){tween_stop(plane.tweenScale);plane.tweenScale=null;}}});}};})();